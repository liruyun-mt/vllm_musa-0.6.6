...
void selective_scan_fwd_launch(SSMParamsBase &params, musaStream_t stream) {
...
void selective_scan_fwd_cuda(SSMParamsBase &params, musaStream_t stream) {
...
template void selective_scan_fwd_cuda<at::BFloat16, float>(SSMParamsBase &params, musaStream_t stream);
template void selective_scan_fwd_cuda<at::Half, float>(SSMParamsBase &params, musaStream_t stream);
template void selective_scan_fwd_cuda<float, float>(SSMParamsBase &params, musaStream_t stream);
...
void selective_scan_fwd(const torch::Tensor &u, const torch::Tensor &delta,
    ...
    at::cuda::MUSAGuard device_guard{(char)u.get_device()};
