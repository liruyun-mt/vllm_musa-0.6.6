...
void causal_conv1d_fwd_cuda(ConvParamsBase &params, musaStream_t stream);

template<typename input_t, typename weight_t>
void causal_conv1d_update_cuda(ConvParamsBase &params, musaStream_t stream);
...
void causal_conv1d_fwd(const at::Tensor &x, const at::Tensor &weight,
    ...
    at::cuda::MUSAGuard device_guard{(char)x.get_device()};
...
void causal_conv1d_fwd_launch(ConvParamsBase &params, musaStream_t stream) {
    ...
    BOOL_SWITCH(params.seqlen % kNElts == 0 && !kVarlen, kIsVecLoad, [&] {
        ...
        if (kSmemSize >= 48 * 1024) {
            #ifndef USE_ROCM
            C10_CUDA_CHECK(musaFuncSetAttribute(
                kernel, musaFuncAttributeMaxDynamicSharedMemorySize, kSmemSize));
            #else
            // There is a slight signature discrepancy in HIP and CUDA "FuncSetAttribute" function.
            C10_CUDA_CHECK(musaFuncSetAttribute(
                (void *) kernel, musaFuncAttributeMaxDynamicSharedMemorySize, kSmemSize));
...
template void causal_conv1d_fwd_cuda<float, float>(ConvParamsBase &params, musaStream_t stream);
template void causal_conv1d_fwd_cuda<at::Half, at::Half>(ConvParamsBase &params, musaStream_t stream);
template void causal_conv1d_fwd_cuda<at::BFloat16, at::BFloat16>(ConvParamsBase &params, musaStream_t stream);
...
template<int kNThreads, int kWidth, typename input_t, typename weight_t>
void causal_conv1d_update_launch(ConvParamsBase &params, musaStream_t stream) {
...
template void causal_conv1d_update_cuda<float, float>(ConvParamsBase &params, musaStream_t stream);
template void causal_conv1d_update_cuda<at::Half, at::Half>(ConvParamsBase &params, musaStream_t stream);
template void causal_conv1d_update_cuda<at::BFloat16, at::BFloat16>(ConvParamsBase &params, musaStream_t stream);
