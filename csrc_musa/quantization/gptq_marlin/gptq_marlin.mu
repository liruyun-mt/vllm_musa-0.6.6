...
#define STATIC_ASSERT_SCALAR_TYPE_VALID(scalar_t)               \
  static_assert(std::is_same<scalar_t, half>::value ||          \
                    std::is_same<scalar_t, mt_bfloat16>::value, \
  ...
  if constexpr (std::is_same<scalar_t, half>::value) {
    asm volatile(
        ...
        : "r"(a[0]), "r"(a[1]), "r"(a[2]), "r"(a[3]), "r"(b[0]), "r"(b[1]),
          "f"(c[0]), "f"(c[1]), "f"(c[2]), "f"(c[3]));
  } else if constexpr (std::is_same<scalar_t, mt_bfloat16>::value) {
    asm volatile(
...
template <>
__device__ inline typename ScalarType<mt_bfloat16>::FragB
dequant<mt_bfloat16, vllm::kU4B8.id()>(int q) {
  ...
  typename ScalarType<mt_bfloat16>::FragB frag_b;
  static constexpr uint32_t MUL = 0x3F803F80;
  static constexpr uint32_t ADD = 0xC308C308;

  frag_b[0] = __hfma2(*reinterpret_cast<mt_bfloat162*>(&lo),
                      *reinterpret_cast<const mt_bfloat162*>(&MUL),
                      *reinterpret_cast<const mt_bfloat162*>(&ADD));
  frag_b[1] = __hfma2(*reinterpret_cast<mt_bfloat162*>(&hi),
                      *reinterpret_cast<const mt_bfloat162*>(&MUL),
                      *reinterpret_cast<const mt_bfloat162*>(&ADD));
  return frag_b;
}
...
template <>
__device__ inline typename ScalarType<mt_bfloat16>::FragB
dequant<mt_bfloat16, vllm::kU4.id()>(int q) {
  static constexpr uint32_t MASK = 0x000f000f;
  static constexpr uint32_t EX = 0x43004300;
...
template <>
__device__ inline typename ScalarType<mt_bfloat16>::FragB
dequant<mt_bfloat16, vllm::kU8B128.id()>(int q) {
  typename ScalarType<mt_bfloat16>::FragB frag_b;
...
template <>
__device__ inline typename ScalarType<mt_bfloat16>::FragB
dequant<mt_bfloat16, vllm::kU8.id()>(int q) {
  typename ScalarType<mt_bfloat16>::FragB frag_b;
...
void marlin_mm(const void* A, const void* B, void* C, void* C_tmp, void* s,
               ...
               int dev, musaStream_t stream, int thread_k, int thread_n,
