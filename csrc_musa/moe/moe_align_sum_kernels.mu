  ...
  if (num_experts >= 256) {
    VLLM_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_global_mem_kernel", [&] {
          ...
          int32_t* tokens_cnts;
          int32_t* cumsum;
          musaMalloc(&tokens_cnts, mem_tokens_cnts);
          musaMalloc(&cumsum, mem_cumsum);
    ...
    VLLM_DISPATCH_INTEGRAL_TYPES(
        topk_ids.scalar_type(), "moe_align_block_size_kernel", [&] {
          ...
          AT_MUSA_CHECK(VLLM_DevFuncAttribute_SET_MaxDynamicSharedMemorySize(
